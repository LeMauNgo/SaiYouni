...
public class InventoriesManager : MySingleton<InventoriesManager>
{
    ...
    public virtual bool RemoveItem(ItemCode itemCode, int itemCount)
    {
        ItemProfileSO itemProfile = this.GetProfileByCode(itemCode);
        ItemInventory item = new(itemProfile, itemCount);
    ...
    public virtual bool RemoveItem(ItemInventory itemInventory)
    {
        ...
        return inventoryCtrl.RemoveItem(itemInventory);
    }
